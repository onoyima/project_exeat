...
export default function StudentNavbar({ onMenuClick, user }: { onMenuClick: () => void, user: { fname: string, lname: string, email: string, image?: string } }) {
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="flex items-center space-x-3">
            ...
            <h1 className="text-lg sm:text-xl font-semibold text-green-900">Student Dashboard</h1>
          </div>
          <div className="relative">
            ...
            {dropdownOpen && (
              <div className="absolute right-0 mt-2 w-56 bg-white rounded-md shadow-lg py-2 z-50 border">
                ...
                <a href="/student/profile" className="block px-4 py-2 text-gray-700 hover:bg-green-50">Profile</a>
